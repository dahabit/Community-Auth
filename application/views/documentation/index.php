...
<p>
	The links to each of the three documentation steps are provided at the top of each documentation page. Please start with <?php echo anchor('documentation/configuration', 'Configuration'); ?> and work your way down. You'll have Community Auth up and running in no time at all.
</p>
